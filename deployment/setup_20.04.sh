...
function install_dependencies() {
  ...
  echo "deb [signed-by=/etc/apt/keyrings/postgresql.gpg] http://apt.postgresql.org/pub/repos/apt/ $(lsb_release -cs)-pgdg 16" | sudo tee /etc/apt/sources.list.d/pgdg.list
